...
import LikeHabit from "@/app/utils/allHabitsUtils/LikeHabit";
import ReminderButton from "@/app/utils/allHabitsUtils/RemindeButton";

//
//

export default function StatisticsHabitCard({
  habit,
  setSharedHabits,
  user,
}: {
